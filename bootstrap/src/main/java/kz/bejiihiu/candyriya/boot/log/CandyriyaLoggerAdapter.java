...
public class CandyriyaLoggerAdapter extends CoreLoggerAdapter {

    @Override
    protected Logger newLogger(final String name, final LoggerContext context) {
        Logger logger = super.newLogger(name, context);
        if (logger instanceof ApiLogger) {
            return new CandyriyaJulLogger(logger);
        } else {
            return logger;
        }
    }

    public static class CandyriyaJulLogger extends Logger {

        private final Logger logger;

        protected CandyriyaJulLogger(Logger logger) {

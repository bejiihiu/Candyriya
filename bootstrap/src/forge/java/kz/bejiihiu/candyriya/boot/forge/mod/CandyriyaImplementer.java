...
import kz.bejiihiu.candyriya.boot.asm.*;
import kz.bejiihiu.candyriya.boot.log.CandyriyaI18nLogger;
...
public class CandyriyaImplementer implements ILaunchPluginService {

    static final Logger LOGGER = CandyriyaI18nLogger.getLogger("Implementer");
    ...
    public CandyriyaImplementer() {
        this(detectTransformLogger());
    }

    public CandyriyaImplementer(boolean logger) {
        this.logger = logger;
    }

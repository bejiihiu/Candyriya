...
) : MessageToByteEncoder<kz.bejiihiu.candyriya.protocol.MinecraftPacket>() {

    private val deflater = Deflater()

    override fun encode(ctx: ChannelHandlerContext, msg: kz.bejiihiu.candyriya.protocol.MinecraftPacket, out: ByteBuf) {

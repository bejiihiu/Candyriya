...
import kz.bejiihiu.candyriya.gradle.api.extension.ICandyriyaExtension;
...
public class CandyriyaExtension implements ICandyriyaExtension {
    ...
    private final ICandyriyaMappingsExtension mappingsConfiguration = new CandyriyaMappingsExtension();

    public CandyriyaExtension(Project project) {
        this.cacheDir = project.getRootProject().getRootDir().toPath().resolve(".gradle/Candyriya");
    }
    ...
    @Override
    public ICandyriyaMappingsExtension getMappingsConfiguration() {
        return mappingsConfiguration;
    }

    @Override
    public void mappings(Action<ICandyriyaMappingsExtension> spec) {

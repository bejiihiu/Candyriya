package kz.bejiihiu.candiriya.network.forwarding
 ...
 *
 * For Candiriya we are mostly offline-mode without IdentifiedKey, so we always use version 1 (MODERN_DEFAULT).

...
public class ArclightServer {
    ...
    public static final Logger LOGGER = ArclightI18nLogger.getLogger(kz.bejiihiu.candyriya.Brand.NAME);
    // Candyriya end
    ...
    public static CraftServer createOrLoad(DedicatedServer console, PlayerList playerList) {
        if (server == null) {
            try {
                ...
                throw new RuntimeException("Error initializing " + kz.bejiihiu.candyriya.Brand.NAME, t);
            }
            try {

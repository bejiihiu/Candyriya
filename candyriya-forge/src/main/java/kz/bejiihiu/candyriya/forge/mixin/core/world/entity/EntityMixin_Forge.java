...
public abstract class EntityMixin_Forge implements EntityBridge, IForgeEntity {
    ...
    private Vec3 Candyriya$setLava(FluidState instance, BlockGetter level, BlockPos pos) throws Throwable {
    ...
    public Collection<ItemEntity> Candyriya$forceDrops(Entity entity) throws Throwable {

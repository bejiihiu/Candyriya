...
public abstract class AbstractFurnaceBlockEntityMixin_Forge {
    ...
    private <E> E Candyriya$furnaceSmelt(NonNullList<E> instance, int i, @Local(ordinal = 1) ItemStack itemStack2, @Local(ordinal = 0) ItemStack itemStack1) throws Throwable {

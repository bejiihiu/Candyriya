...
public abstract class ServerLoginPacketListenerImplMixin_Fabric implements ServerLoginPacketListenerImplBridge, NetworkHandlerExtensions {
    ...
    @Override
    public FriendlyByteBuf Candyriya$platform$customQAData(ServerboundCustomQueryAnswerPacket packet) {
    ...
    @Override
    public void Candyriya$platform$onCustomQA(ServerboundCustomQueryAnswerPacket payload) {

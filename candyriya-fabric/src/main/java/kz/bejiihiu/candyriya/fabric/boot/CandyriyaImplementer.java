package kz.bejiihiu.candyriya.fabric.boot;
...
public class CandyriyaImplementer extends GameTransformer {
    ...
    public CandyriyaImplementer(GameTransformer delegate, FabricLauncher launcher) throws Exception {

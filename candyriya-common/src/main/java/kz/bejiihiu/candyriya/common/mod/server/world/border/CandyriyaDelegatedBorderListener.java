...
public class CandyriyaDelegatedBorderListener extends BorderChangeListener.DelegateBorderChangeListener {

    public static boolean isEnabled() {
        // return CandyriyaConfig.spec().getCompat().isAssociateWorldBorder();
        return true;
    }

    private final BorderChangeListener.DelegateBorderChangeListener delegate;

    public CandyriyaDelegatedBorderListener(WorldBorder border, BorderChangeListener.DelegateBorderChangeListener delegate) {
        super(border);

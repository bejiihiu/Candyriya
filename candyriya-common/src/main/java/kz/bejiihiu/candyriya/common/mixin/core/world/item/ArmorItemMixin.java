...
import kz.bejiihiu.candyriya.common.mod.server.block.DispenserBlockHooks;
...
public class ArmorItemMixin {
    ...
    private static void Candyriya$dispense(LivingEntity instance, EquipmentSlot equipmentSlot, ItemStack stack, BlockSource blockSource, ItemStack itemStack, @Local(ordinal = -1) ItemStack itemstack1) throws Throwable {

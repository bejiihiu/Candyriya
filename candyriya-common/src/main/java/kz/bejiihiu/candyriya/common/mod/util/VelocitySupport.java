...
// Changes are made to use Candyriya configuration system
public class VelocitySupport {

    public static boolean isEnabled() {
        return CandyriyaConfig.spec().getVelocity().isEnable();
    }
    ...
    public static boolean checkIntegrity(final FriendlyByteBuf buf) {
        ...
        try {
            ...
            mac.init(new SecretKeySpec(CandyriyaConfig.spec().getVelocity().getSecret().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));

...
public interface NeighborUpdaterMixin {
    ...
    private static void Candyriya$blockPhysicsEvent(BlockState instance, Level level, BlockPos pos, Block block, BlockPos source, boolean b) throws Throwable {
    ...
    private static void Candyriya$setLastPhysicsProblem(Level level, BlockState instance, BlockPos pos, @Local(ordinal = -1) Throwable t) {

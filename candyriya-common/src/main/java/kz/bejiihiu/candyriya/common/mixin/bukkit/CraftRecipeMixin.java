...
import kz.bejiihiu.candyriya.common.bridge.core.world.item.crafting.IngredientBridge;
import kz.bejiihiu.candyriya.common.mod.inventory.CandyriyaSpecialIngredient;
...
public interface CraftRecipeMixin {
    ...
    default Ingredient toNMS(RecipeChoice bukkit, boolean requireNotEmpty) {
        ...
        } else if (bukkit instanceof CandyriyaSpecialIngredient) {
            stack = ((CandyriyaSpecialIngredient) bukkit).getIngredient();
        } else {
    ...
    static RecipeChoice toBukkit(Ingredient list) {
        ...
        if (list.getClass() != Ingredient.class) {
            return new CandyriyaSpecialIngredient(list);
        }

...
import kz.bejiihiu.candyriya.common.mixin.core.world.entity.raid.RaiderMixin;
...
public abstract class WitchMixin extends RaiderMixin {
    ...
    private void Candyriya$reason(PotionContents instance, Consumer<MobEffectInstance> consumer) throws Throwable {

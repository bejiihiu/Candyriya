package kz.bejiihiu.candyriya.common.mod.server.command;

import kz.bejiihiu.candyriya.common.mod.server.permission.CandyriyaDummyPermissible;
...
public class CandyriyaDummyCommandSender extends CandyriyaDummyPermissible implements CommandSender {

    public CommandSourceStack stack;
    public Spigot spigot;

    public CandyriyaDummyCommandSender(CommandSourceStack stack) {
        this.stack = stack;
    }

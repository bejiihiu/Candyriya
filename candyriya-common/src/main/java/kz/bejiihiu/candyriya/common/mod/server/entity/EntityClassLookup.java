...
public class EntityClassLookup {
    ...
    static {
        // abstract types
        add(Entity.class, new EntityClass<>(org.bukkit.entity.Entity.class, CandyriyaModEntity.class, CandyriyaModEntity::new));
        add(AbstractSkeleton.class, new EntityClass<>(org.bukkit.entity.AbstractSkeleton.class, CandyriyaModAbstractSkeleton.class, CandyriyaModAbstractSkeleton::new));
        add(Mob.class, new EntityClass<>(org.bukkit.entity.Mob.class, org.bukkit.craftbukkit.v.entity.CraftMob.class, CandyriyaModMob::new));
        add(AbstractMinecart.class, new EntityClass<>(org.bukkit.entity.Minecart.class, CandyriyaModMinecart.class, CandyriyaModMinecart::new));
        add(AbstractMinecartContainer.class, new EntityClass<>(org.bukkit.entity.Minecart.class, CandyriyaModMinecartContainer.class, CandyriyaModMinecartContainer::new));
        add(AbstractHorse.class, new EntityClass<>(org.bukkit.entity.AbstractHorse.class, CandyriyaModHorse.class, CandyriyaModHorse::new));
        add(AbstractChestedHorse.class, new EntityClass<>(org.bukkit.entity.ChestedHorse.class, CandyriyaModChestedHorse.class, CandyriyaModChestedHorse::new));
        add(Projectile.class, new EntityClass<>(org.bukkit.entity.Projectile.class, CandyriyaModProjectile.class, CandyriyaModProjectile::new));
        add(Raider.class, new EntityClass<>(org.bukkit.entity.Raider.class, CandyriyaModRaider.class, CandyriyaModRaider::new));
        add(VehicleEntity.class, new EntityClass<>(org.bukkit.entity.Vehicle.class, CandyriyaModVehicle.class, CandyriyaModVehicle::new));
        add(AbstractWindCharge.class, new EntityClass<>(org.bukkit.entity.AbstractWindCharge.class, CandyriyaModWindCharge.class, CandyriyaModWindCharge::new));
        ...
        add(ThrowableItemProjectile.class, new EntityClass<>(org.bukkit.entity.ThrowableProjectile.class, CandyriyaModThrowableProjectile.class, CandyriyaModThrowableProjectile::new));

...
public class ProjectileWeaponItemMixin {
    ...
    private boolean Candyriya$shootBow(ServerLevel instance, Entity entity, ServerLevel serverLevel, LivingEntity livingEntity, InteractionHand interactionHand, ItemStack itemStack,

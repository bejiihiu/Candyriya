...
public class CandyriyaModdedMenuContainer implements Container, IInventoryBridge {

    private final AbstractContainerMenu container;
    private InventoryHolder owner;
    private final List<HumanEntity> viewers = new ArrayList<>();

    public CandyriyaModdedMenuContainer(AbstractContainerMenu container, Player owner) {

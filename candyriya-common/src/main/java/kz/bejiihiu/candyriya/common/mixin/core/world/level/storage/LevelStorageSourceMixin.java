...
public abstract class LevelStorageSourceMixin implements LevelStorageSourceBridge {
    ...
    @Override
    public LevelStorageSource.LevelStorageAccess Candyriya$validateAndCreateAccess(String saveName, ResourceKey<LevelStem> world) throws IOException, ContentValidationException {

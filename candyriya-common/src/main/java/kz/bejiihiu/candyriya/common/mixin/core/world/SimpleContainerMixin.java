package kz.bejiihiu.candyriya.common.mixin.core.world;
...
public abstract class SimpleContainerMixin implements Container, IInventoryBridge {
    ...
    @ShadowConstructor
    public void Candyriya$constructor(int numSlots) {
        throw new RuntimeException();
    }

    @CreateConstructor
    public void Candyriya$constructor(int numSlots, InventoryHolder owner) {
        this.Candyriya$constructor(numSlots);

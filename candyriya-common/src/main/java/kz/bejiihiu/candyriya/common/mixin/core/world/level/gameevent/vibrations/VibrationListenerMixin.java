package kz.bejiihiu.candyriya.common.mixin.core.world.level.gameevent.vibrations;
...
public abstract class VibrationListenerMixin {
    ...
    private boolean Candyriya$gameEvent(VibrationSystem.User instance, ServerLevel serverLevel, BlockPos pos, Holder<GameEvent> gameEventHolder, GameEvent.Context context) throws Throwable {

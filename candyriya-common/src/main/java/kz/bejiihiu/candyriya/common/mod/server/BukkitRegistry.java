...
import kz.bejiihiu.candyriya.common.bridge.bukkit.SimpleRegistryBridge;
import kz.bejiihiu.candyriya.common.mod.server.entity.EntityClassLookup;
import kz.bejiihiu.candyriya.common.mod.util.ResourceLocationUtil;
...
public class BukkitRegistry {
    ...
    private static MaterialPropertySpec matSpec(ResourceLocation location) {
        return CandyriyaConfig.spec().getCompat().getMaterial(location.toString()).orElse(MaterialPropertySpec.EMPTY);
    }

    private static EntityPropertySpec entitySpec(ResourceLocation location) {
        return CandyriyaConfig.spec().getCompat().getEntity(location.toString()).orElse(EntityPropertySpec.EMPTY);
    }

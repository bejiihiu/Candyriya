...
import kz.bejiihiu.candyriya.common.bridge.core.world.level.material.LavaFluidBridge;
...
public abstract class LavaFluidMixin implements LavaFluidBridge {
    ...
    private boolean Candyriya$blockFromTo(LevelAccessor world, BlockPos pos, BlockState newState, int flags) throws Throwable {

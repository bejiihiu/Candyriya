...
public class BaseFireBlockMixin {
    ...
    private void Candyriya$onFire(Entity instance, float f, BlockState blockState, Level level, BlockPos blockPos) throws Throwable {
    ...
    public boolean Candyriya$extinguish2(Level world, BlockPos pos, boolean isMoving) {

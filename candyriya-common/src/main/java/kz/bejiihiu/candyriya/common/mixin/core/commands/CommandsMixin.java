...
import kz.bejiihiu.candyriya.common.bridge.core.commands.CommandsBridge;
...
import kz.bejiihiu.candyriya.common.mod.util.BukkitDispatcher;
...
public abstract class CommandsMixin implements CommandsBridge {
    ...
    private <S> boolean Candyriya$canUse(CommandNode<S> commandNode, S source) {

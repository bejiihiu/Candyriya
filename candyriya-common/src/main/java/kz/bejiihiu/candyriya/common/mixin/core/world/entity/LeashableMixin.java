...
public interface LeashableMixin {
    ...
    private void Candyriya$skipRemoved(CompoundTag compoundTag, Leashable.LeashData leashData) throws Throwable {
    ...
    private static ItemEntity Candyriya$forceDrop(Entity instance, ItemLike itemLike) throws Throwable {
    ...
    private static ItemEntity Candyriya$forceDrop2(Entity instance, ItemLike itemLike) throws Throwable {
        instance.bridge().bridge$setForceDrops(true);
        var itemEntity = (ItemEntity) DecorationOps.callsite().invoke(instance, itemLike);
        instance.bridge().bridge$setForceDrops(false);
        return itemEntity;
    ...
    private static <E extends Entity & Leashable> void Candyriya$unleashEvent(E entity, boolean bl, boolean bl2) throws Throwable {
    ...
    private void Candyriya$distanceLeash() {

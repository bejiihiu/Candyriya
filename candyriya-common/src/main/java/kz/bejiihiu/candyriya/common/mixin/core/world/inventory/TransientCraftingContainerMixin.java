...
public abstract class TransientCraftingContainerMixin implements TransientCraftingContainerBridge, Container {
    ...
    @ShadowConstructor
    public void Candyriya$constructor(AbstractContainerMenu eventHandlerIn, int width, int height) {
        throw new RuntimeException();
    }

    @CreateConstructor
    public void Candyriya$constructor(AbstractContainerMenu eventHandlerIn, int width, int height, Player owner) {
        Candyriya$constructor(eventHandlerIn, width, height);
        this.owner = owner;
    }

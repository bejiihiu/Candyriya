...
public class CandyriyaInterfaceInvokerGen implements PluginTransformer {

    public static final CandyriyaInterfaceInvokerGen INSTANCE = new CandyriyaInterfaceInvokerGen();

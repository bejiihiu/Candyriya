...
public class CandyriyaDamageContainer {
    private final EntityDamageEvent bukkit;
    private float currentDamage;

    public CandyriyaDamageContainer(EntityDamageEvent bukkit) {
        this.bukkit = bukkit;
    ...
    public float calculateStage(EntityDamageEvent.DamageModifier stage, float original) {
        ...
        if (bridge.Candyriya$applicable(stage) && bridge.Candyriya$isStillOriginal(stage, before, original)) {

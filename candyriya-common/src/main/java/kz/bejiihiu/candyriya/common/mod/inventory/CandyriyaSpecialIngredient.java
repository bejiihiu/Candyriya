package kz.bejiihiu.candyriya.common.mod.inventory;
...
public class CandyriyaSpecialIngredient implements RecipeChoice {

    private final Ingredient ingredient;

    public CandyriyaSpecialIngredient(Ingredient ingredient) {
    ...
    public boolean equals(Object o) {
        ...
        CandyriyaSpecialIngredient that = (CandyriyaSpecialIngredient) o;

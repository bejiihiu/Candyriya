...
import kz.bejiihiu.candyriya.command.PlayerSource
 ...
 * Per velocity spec: granted to all by default (`Candyriya.command.server`).
...
public class ServerCommand(
    ...
    override val permission: String = "Candyriya.command.server"

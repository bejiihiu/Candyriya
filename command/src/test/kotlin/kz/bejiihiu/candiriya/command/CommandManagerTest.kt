...
public class CommandManagerTest {
    ...
    public fun `console bypasses permission`() {
        ...
        assertThat(src.hasPermission("candiriya.secret")).isTrue
    ...
    public fun `suggest filters by permission`() {
        ...
        cm.register("secret", TestCommand(permission = "candiriya.secret"))
        ...
        val srcPerm = player(setOf("candiriya.secret"))
    ...
    public fun `alias works`() {
        val cm = CommandManager()
        val cmd = TestCommand()
        cm.register("candiriya", cmd, "candyriya")
        val src = console()
